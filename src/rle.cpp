/* Borrowed from https://github.com/bfredl/delugeclient */
...
// the below is taken verbatim from deluge source code
// we need to figure out a way to share client code with deluge code
